...
function getTodaySoul() {
  ...
  const todaySoul = soul[Math.floor(Math.random() * soul.length)];
  return todaySoul;
}

async function sendTextToDingtalkRebot(text) {
  const addr = "https://oapi.dingtalk.com/robot/send?access_token=262ccf6e262128a848acd4b1e8f3a0457c5efb8da89f63709d3530c1b5422123";
  axios({
    method: 'post',
    url: addr,
    data: {
...
async function run() {
  const ts = getTodaySoul();
  await sendTextToDingtalkRebot(ts)
}
